                ...
                <tbody>
                    ...
                    ?>
                        <tr>
                            ...
                            <td>
                                <a href='index.php?page=tier_view&tier_id=<?php echo $row['trigger_tier_id']?><?php if($row['trigger_area_id'] != ""){echo "&area_id={$row['trigger_area_id']}";}else{echo "";} ?>'  class='' ><i data-toggle='tooltip' data-placement='left' title='Accept' style='font-size: 20px; color:#b5b5b5' class='far fa-eye options'></i></a>
                            </td>
